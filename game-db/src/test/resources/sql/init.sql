...
CREATE TABLE IF NOT EXISTS `db_0`.`t_more_order`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_0`.`t_more_order_0`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_0`.`t_more_order_1`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_0`.`t_tocken`
(
    `id` VARCHAR
(
    50
), `user_id` BIGINT NOT NULL, `status` VARCHAR
(
    50
), PRIMARY KEY
(
...
CREATE TABLE IF NOT EXISTS `db_0`.`t_tocken_0`
(
    `id` VARCHAR
(
    50
...
CREATE TABLE IF NOT EXISTS `db_0`.`t_tocken_1`
(
    `id` VARCHAR
(
    50
...
CREATE TABLE IF NOT EXISTS `db_1`.`t_order`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_1`.`t_more_order`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_1`.`t_more_order_0`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_1`.`t_more_order_1`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_1`.`t_tocken`
(
    `id` VARCHAR
(
    50
...
CREATE TABLE IF NOT EXISTS `db_1`.`t_tocken_0`
(
    `id` VARCHAR
(
    50
...
CREATE TABLE IF NOT EXISTS `db_1`.`t_tocken_1`
(
    `id` VARCHAR
(
    50
...
CREATE TABLE IF NOT EXISTS `db_2`.`t_order`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_2`.`t_more_order`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_2`.`t_more_order_0`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_2`.`t_more_order_1`
(
    `id`
    BIGINT
    NOT
...
CREATE TABLE IF NOT EXISTS `db_2`.`t_tocken`
(
    `id` VARCHAR
(
    50
...
CREATE TABLE IF NOT EXISTS `db_2`.`t_tocken_0`
(
    `id` VARCHAR
(
    50
...
CREATE TABLE IF NOT EXISTS `db_2`.`t_tocken_1`
(
    `id` VARCHAR
(
    50
